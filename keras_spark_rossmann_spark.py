...
print('==============')
print('Model training- build model')
print('==============')
# Build the model.
...
print('==============')
print('Model training - optimizer')
print('==============')
...
history, best_model_bytes = \
    horovod.spark.run(train_fn, args=(model_bytes,), num_proc=NUM_TRAINING_PROC, verbose=0)[0]
